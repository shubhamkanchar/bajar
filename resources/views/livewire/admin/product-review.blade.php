                ...
                <div class="col-12">
                    <div class="row bg-secondary-subtle rounded align-items-center m-2 p-2">
                        <div class="col-12 col-md-2 border-end border-secondary">
                            <span class="text-secondary text-title"> {{ $product->name }} </span>
                        ...
                        <div class="col-12 col-md-6 border-end border-secondary">
                            <div class="row">
                                @foreach ($product->images as $image)
                                    <div class="col-2">
                                        <img src="{{ asset('storage/' . $image->path) }}" class="d-block w-100 rounded ratio ratio-1x1" alt="Service Image" loading="lazy">
                                    </div>
                                @endforeach
                            </div>
                        </div>
