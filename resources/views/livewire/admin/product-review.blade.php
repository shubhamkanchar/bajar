<div>
    <div class="row border-bottom">
        <div class="col-md-9 mt-2 pb-2">
            <span role="button" class="badge rounded-pill text-dark border border-2 fs-6 px-4 py-2 m-1 border-dark bg-secondary-subtle">Recent</span>
            <span role="button" class="badge rounded-pill text-dark border border-2 fs-6 px-4 py-2 m-1">Oldest</span>
            <span role="button" class="badge rounded-pill text-dark border border-2 fs-6 px-4 py-2 m-1">By Seller</span>
            <span role="button" class="badge rounded-pill text-dark border border-2 fs-6 px-4 py-2 m-1">Date Range</span>
        </div>
        <div class="col-md-3">
