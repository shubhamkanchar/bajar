            ...
            @if ($step === 1)
                ...
                <div class="row">
                    <div class="col-xxl-4 col-xl-2 col-md-6 col-lg-6 col-6 mb-3">
                        <button class="border rounded-4 py-5 px-md-5 px-3 text-center {{ $userType === 'individual' ? 'border-dark' : '' }}" wire:click="selectUserType('individual')">
                    ...
                    <div class="col-xxl-4 col-xl-2 col-md-6 col-lg-6 col-6 mb-3">
                        <button class="border rounded-4 py-5 px-md-5 px-3 text-center {{ $userType === 'business' ? 'border-dark' : '' }}" wire:click="selectUserType('business')">
                            <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            @elseif($step == 3 && $userType === 'business')
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 mb-2" wire:click="setOffering('product')">
                        <button class="row width-100 border border-2 rounded-2 p-3 me-1 align-items-center w-100">
                            <span class="col-2">
                    ...
                    <div class="col-lg-6 col-md-12" wire:click="setOffering('service')">
                        <button class="row width-100 border border-2 rounded-2 p-3 ms-1 align-items-center w-100">
                            <span class="col-2">
