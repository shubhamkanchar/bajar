        ...
        <div class="offset-xl-2 offset-lg-1 col-xl-5 col-lg-7 col-md-6 col-sm-12 p-4">
            ...
            @elseif($step == 3 && $userType === 'individual')
                ...
                <div class="d-flex mt-5">
                    ...
                    <button class="btn btn-dark btn-sm px-5 rounded-5" wire:click="finalize"
                        {{ $userType ? '' : 'disabled' }}>
                        Done
                    </button>
                </div>
                    ...
                    <div class="col-12 mb-3">
                        <div class="form-floating">
                            <input type="text" id="business_address" class="form-control"
                                wire:model="address" placeholder="Please enter your business address">
