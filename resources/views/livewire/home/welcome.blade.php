            ...
            <div class="col-12 mt-4 text-center rounded-4"
                ...
                <div class="d-md-flex position-relative justify-content-center mb-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between bg-white rounded-5 p-2 border mt-2 mt-md-0"
                        ...
                        <input wire:model="productName" class="form-control border border-0 rounded-5 me-2 bg-white" type="text"
                            placeholder="Search" @focus='focused = true' @blur="focused = false">
                        @if($searchStarted)
                            <button type="button" class="btn btn-dark rounded-5 email-toggle-btn pt-2 pb-2 ps-4 pe-4" wire:click="clearSearch()">Clear</button>
                        @else
                        ...
                        @foreach ($sellers as $seller)
                            <div class="col">
                                <div class="card h-100 shadow-sm">
                                    <img src="{{ $seller->profile_image }}" class="card-img-top" alt="{{ $seller['name'] }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="mb-1 small text-muted">GST Number: {{ $seller->gst ?? '-' }}</p>
