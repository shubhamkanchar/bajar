                    ...
                    <div class="row py-md-4 py-2">
                        ...
                        <div class="col-md-3 my-2 mt-md-5 mb-md-3 order-1 order-md-2">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="#" class="text-dark fw-bold text-decoration-none py-md-0 py-2">Blogs</a></li>
                                <li><a href="#" class="text-dark fw-bold text-decoration-none py-md-0 py-2">Terms and Conditions</a></li>
                                <li><a href="#" class="text-dark fw-bold text-decoration-none py-md-0 py-2">Privacy Policy</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-md-4 my-2 mt-md-5 mb-md-3 order-2 order-md-3 text-md-end text-start ">
                            ...
                            <span class="mt-2"><a href="#" class="d-md-block d-none text-secondary text-decoration-none">@
                                {{ env('APP_NAME') }}</a></span>
                        </div>
