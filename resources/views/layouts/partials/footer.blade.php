<footer class="bg-secondary-subtle text-dark mt-5">
    <div class="container pt-4 pb-1">
        <div class="row py-md-4 py-2">
            <!-- Column 1 -->
            <div class="col-md-5 mt-2 my-md-2 order-3 order-md-1">
                ...
                <div class="gap-4 d-flex py-4 border-bottom-only-mobile border-bottom border-secondary pb-md-0 pb-5">
                    ...
                    <span>
                        <a href="https://www.facebook.com/share/19968RzUjy/" target="_blank">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <a target="_blank" href="https://x.com/bajarbhaw?s=09">
                        <img src="{{ asset('assets/image/fi_174883.png') }}">
                    </a>
                </div>
            </div>

            <div class="col-md-3 my-2 mt-md-5 mb-md-3 order-1 order-md-2">
                {{-- <h5>Quick Links</h5> --}}
                <ul class="list-unstyled border-bottom-only-mobile border-bottom border-secondary pb-md-0 pb-5">
                    <li class="py-1"><a href="{{route('blogs')}}" class="text-dark fw-bold text-decoration-none">Blogs</a>
                    </li>
                    <li class="py-1"><a href="{{route('page',['slug'=>'terms-and-conditions'])}}" class="text-dark fw-bold text-decoration-none">Terms and
                            Conditions</a></li>
                    <li class="py-1"><a href="{{route('page',['slug'=>'privacy-policy'])}}" class="text-dark fw-bold text-decoration-none">Privacy
                            Policy</a>
                    </li>
                    <li class="py-1"><a href="{{route('page',['slug'=>'refund-policy'])}}" class="text-dark fw-bold text-decoration-none">Refund Policy</a>
                    </li>
                </ul>
            </div>

            <div class="col-md-4 my-2 mt-md-5 mb-md-3 order-2 order-md-3 text-md-end text-start ">
                <ul class="list-unstyled border-bottom-only-mobile border-bottom border-secondary pb-md-0 pb-5">
                    <li class="py-2"><a href="#" class="text-dark fw-bold text-decoration-none">Contact</a></li>
                    <li><a href="#" class="text-secondary text-decoration-none">{{ env('APP_EMAIL') }}</a>
                    </li>
                    <li><a href="#" class="text-secondary text-decoration-none">{{ env('APP_PHONE') }}</a>
                    </li>
                </ul>
                <span class="mt-2"><a href="#"
                        class="d-md-block d-none text-secondary text-decoration-none">@
                        {{ env('APP_NAME') }}</a></span>
            </div>
            <div class="col-12 d-block d-md-none order-4 pt-3">
