...
@section('content')
    <div class="container">
        <div class="row pb-md-0 pb-4">
            <div class="col-md-6">
                <button class="btn btn-defualt @if ($page == 'signin') d-none @endif"
                    wire:click="pageChange('signin')">
                        ...
                        <form id="phoneForm" class="phone-div">
                            ...
                            <div class="row mt-2  text-center">
                                <div class="col-md-12 my-5">
                                    New to {{ env('APP_NAME') }}? <a href="{{ route('signup') }}" class="text-primary">Sign Up</a>
                                </div>
                            </div>
                        </form>
